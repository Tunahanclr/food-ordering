      ...
      <div className="container mx-auto z-50 text-white flex justify-between items-center h-full">
        ...
        <div className="flex  z-50 gap-x-4 items-center">
          ...
          <span className="relative">
              ...
              <span className="w-4 h-4  text-xs  flex items-baseline justify-center rounded-full bg-primary absolute -top-2 -right-3 text-black font-bold">
          ...
          <button className="btn-primary md:inline-block hidden sm">
            Order Online
          </button>
          <button
