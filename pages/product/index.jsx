...
const dispatch=useDispatch()
      ...
      // start small medium big pizza vs 
    ...
    //checked işlem
      ...
      console.log(extras);
          ...
          const handleClick=()=>{
            ...
            console.log(cart)
    return (
    <div className="flex items-center md:h-screen gap-5 md:gap-10 py-20 flex-wrap ">
      <div className="relative md:flex-1 md:w-[80%] md:h-[80%] w-40 h-40 mx-auto">
      ...
      <div className="md:flex-1  md:text-start text-center">
        ...
        <div>
          ...
          <div className="  flex items-center gap-x-20 md:justify-start justify-center">
            <div className="relative w-8 h-8" onClick={()=>handleSize(0)}>
              <Image className="cursor-pointer" src="/images/size.png" alt="" layout="fill" />
